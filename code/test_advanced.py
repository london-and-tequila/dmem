...
def evaluate_dataset(dataset_path: str, model: str, output_path: Optional[str] = None,
    ...
    """Evaluate the A-MEM agent on the LoComo dataset.
    ...
    log_filename = f"eval_{model}_{backend}_ratio{ratio}_{timestamp}.log"
    ...
    memories_dir = os.path.join(os.path.dirname(__file__),
                               "cached_memories_{}_{}".format(backend, model))
...
def main():
    ...
    evaluate_dataset(dataset_path, args.model, output_path, args.ratio, args.backend,
